...
class application_entity_test(unittest.TestCase):
    ...
    def test_object_creation(self):
        testdata = {'needed_services':['apache2'],'files': ['/etc/apache2/sites/available/testsite1'], 'folders': ['/var/www/testsite1/'], 'name': 'testsite1', 'url': 'http://www.testsite1.web', 'master_node': 'www1', 'databases': ['testsite1'], 'slave_node': 'www2', 'packages': ['apache2', 'mysql', 'php5']}
        ...
        self.assertEqual(app.needed_services, ['apache2'])