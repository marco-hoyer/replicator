...
if __name__ == '__main__':
	...
	parser.add_argument("--replicateall", help="replicate all applications", action="store_true")
	...
	parser.add_argument("--backup", help="backup applications", type=str, default="testsite2")
